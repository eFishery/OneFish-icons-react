...
pathsByWeight.set("regular", (color: string) => (
  <>
    <polyline points="128 160 176 208 224 160" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  <polyline points="32 64 176 64 176 208" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  </>
));
...
const ArrowElbowRightDown = forwardRef<SVGSVGElement, IconProps>((props, ref) => (
