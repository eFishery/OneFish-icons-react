...
pathsByWeight.set("regular", (color: string) => (
  ...
  <path d="M56,32a96,96,0,0,1,96,96v96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  </>
));
...
const ArrowBendRightDown = forwardRef<SVGSVGElement, IconProps>((props, ref) => (
