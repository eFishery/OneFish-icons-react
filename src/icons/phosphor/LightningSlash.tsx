...
pathsByWeight.set("regular", (color: string) => (
  <>
    <line x1="48" y1="39.99609" x2="208" y2="215.99609" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  <polyline points="163.777 167.351 96 239.969 112 159.969 48 135.969 92.198 88.614" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  <polyline points="114.106 65.141 160 15.969 144 95.969 208 119.969 185.685 143.878" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  </>
));
