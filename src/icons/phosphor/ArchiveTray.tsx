...
pathsByWeight.set("regular", (color: string) => (
  ...
  <polyline points="94.059 118.059 128 152 161.941 118.059" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  <line x1="128" y1="72" x2="128" y2="152" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
