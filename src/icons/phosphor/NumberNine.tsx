...
pathsByWeight.set("regular", (color: string) => (
  <>
    <line x1="176.48933" y1="115.99533" x2="111.75" y2="224" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  <circle cx="128" cy="88" r="56" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  </>
));
