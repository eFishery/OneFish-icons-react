...
pathsByWeight.set("regular", (color: string) => (
  ...
  <line x1="96" y1="160" x2="128" y2="160" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  ...
  <polyline points="215.276 159.992 160 159.992 160 215.272" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  </>
));
