...
pathsByWeight.set("regular", (color: string) => (
  <>
    <line x1="160" y1="96" x2="40" y2="216" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  <path d="M64,192C16,112,80,32,216,40,224,176,144,240,64,192Z" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  </>
));
