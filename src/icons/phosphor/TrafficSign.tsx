...
pathsByWeight.set("regular", (color: string) => (
  <>
    <polyline points="144 144 168 120 144 96" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  <rect x="45.97561" y="45.97561" width="164.04877" height="164.04877" rx="8" transform="translate(-53.01934 128) rotate(-45)" strokeWidth="16" stroke={color} strokeLinecap="round" strokeLinejoin="round" fill="none"/>
  <path d="M88,152v-8a24,24,0,0,1,24-24h56" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  </>
));
