...
pathsByWeight.set("regular", () => (
  ...
  <path fillRule="evenodd" clipRule="evenodd" d="M9 14.523a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0zm2.25-.75a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5zM6.25 12.273a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5zm-.75 2.25a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0z"/>
  <path fillRule="evenodd" clipRule="evenodd" d="M1 8.023c0-.966.784-1.75 1.75-1.75h18c.966 0 1.75.784 1.75 1.75v9a1.75 1.75 0 0 1-1.75 1.75h-18A1.75 1.75 0 0 1 1 17.023v-9zm1.75-.25a.25.25 0 0 0-.25.25v9c0 .139.112.25.25.25h18a.25.25 0 0 0 .25-.25v-9a.25.25 0 0 0-.25-.25h-18z"/>
  </>
));
