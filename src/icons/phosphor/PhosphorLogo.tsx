...
pathsByWeight.set("regular", (color: string) => (
  <>
    <g>
    <line x1="68" y1="32" x2="134" y2="164" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
    <rect x="68" y="32" width="66" height="132" strokeWidth="16" stroke={color} strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    <path d="M134,164v66a66,66,0,0,1-66-66" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
    <path d="M134,164h8a66,66,0,0,0,0-132h-8" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  </g>
  </>
));
