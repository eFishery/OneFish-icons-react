...
pathsByWeight.set('regular', () => (
  <>
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M7 15.773a4.75 4.75 0 1 1 9.5 0 4.75 4.75 0 0 1-9.5 0zm4.75-3.25a3.25 3.25 0 1 0 0 6.5 3.25 3.25 0 0 0 0-6.5z"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
const TimbanganIkan = forwardRef<SVGSVGElement, IconProps>((props, ref) => (
  <IconBase ref={ref} {...props} viewBox="0 0 24 24" renderPath={renderPath} />
));

TimbanganIkan.displayName = 'TimbanganIkan';

export default TimbanganIkan;
