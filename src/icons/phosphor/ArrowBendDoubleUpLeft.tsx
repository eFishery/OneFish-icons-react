...
pathsByWeight.set("regular", (color: string) => (
  ...
  <polyline points="128 152 80 104 128 56" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  <path d="M224,200a96,96,0,0,0-96-96H80" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  </>
));
...
const ArrowBendDoubleUpLeft = forwardRef<SVGSVGElement, IconProps>((props, ref) => (
