...
pathsByWeight.set("regular", (color: string) => (
  ...
  <path d="M152,84H111.83477L104,132.20232a27.99935,27.99935,0,1,1,0,39.5969" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  </>
));
